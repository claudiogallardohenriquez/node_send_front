        ...
        <div className="w-full mt-20">
            <div>
                ...
                <select 
                    ...
                    className="appearance-none w-full mt-3 bg-white border border-gray-400 text-black py-3 px-4 pr-8 rounded leading-none focus:outline-none focus:border-gray-500">
