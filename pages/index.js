                ...
                <div className="md:flex-1 mb-3 mx-2 mt-16 lg:mt-0">
                  ...
                  <p className="text-lg leading-loose">
                    <span className="text-red-500 font-bold">
                      ...
                      despues de ser descargado. Así puedes mantener lo que compartes en provado y asegurarte de que tus cosas no
                      permanezcan en línea para siempre.
                  </p>
                  <Link href="/crearcuenta">
                      <a className="text-red-500 font-bold text-lg hover:text-red-700 mt-10 flex">
